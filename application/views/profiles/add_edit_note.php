	...
	<tr>
		...
		<td>
			...
			<tr>
				...
				<td>
					<input name="date" type="text" value="<?php echo set_value('date', (isset($note->date) ? $note->date : date('Y-m-d'))); ?>" class="<?php echo (form_error('date')) ? 'inp-form-error' : 'inp-form'; ?>" />
			...
			<tr>
				...
				<td><textarea name="note" rows="" class="<?php echo (form_error('note')) ? 'form-textarea-error' : 'form-textarea'; ?>" style="width:250px;"><?php echo set_value('note', (isset($note->note) ? $note->note : '')); ?></textarea></td>
