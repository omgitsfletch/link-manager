	...
	<tr>
		...
		<td>
			...
			<tr>
				...
				<td>
					<input name="due_date" type="text" value="<?php echo set_value('due_date', (isset($task->due_date) ? $task->due_date : date('Y-m-d'))); ?>" class="<?php echo (form_error('due_date')) ? 'inp-form-error' : 'inp-form'; ?>" />
					<?php echo anchor('', image_asset('forms/icon_calendar.jpg'), array('id' => 'due_date', 'class' => 'date-pick')); ?>
			...
			<tr>
				...
				<td><textarea name="note" rows="" class="<?php echo (form_error('note')) ? 'form-textarea-error' : 'form-textarea'; ?>" style="width:250px;"><?php echo set_value('note', (isset($task->note) ? $task->note : '')); ?></textarea></td>
