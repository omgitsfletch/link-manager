...
<?php endif; ?>
				...
				<!--  start product-table ..................................................................................... -->
				<form id="mainform" action="<?php echo base_url() . 'statuses/delete_multi'; ?>" method="POST">
...
<?php foreach ($statuses AS $index => $row): ?>
				<tr class="<?php echo ($index % 2 == 1) ? 'alternate-row' : ''; ?>">
					...
					<td class="options-width-small">
						<?php echo anchor("statuses/edit/{$row->id}", ' ', array('title' => 'Edit', 'class' => 'icon-1 info-tooltip')); ?>
						<?php echo anchor("statuses/delete/{$row->id}", ' ', array('title' => 'Delete', 'class' => 'icon-2 info-tooltip', 'onclick' => 'return confirm_delete(\'status\')')); ?>
					</td>
				</tr>
<?php endforeach; ?>
				</table>
			...
			<div id="actions-box">
				...
				<div id="actions-box-slider">
					<?php echo anchor('statuses/add', 'Add', array('class' => 'action-edit')); ?>
					<?php echo anchor('javascript://', 'Delete', array('class' => 'action-delete', 'onclick' => 'confirm_multi_delete(\'status\')')); ?>
				</div>
				<div class="clear"></div>
			</div>
			<!-- end actions-box........... -->
