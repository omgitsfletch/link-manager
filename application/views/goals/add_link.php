	...
	<tr>
		...
		<td>
			...
			<tr>
				...
				<td><input name="text" type="text" value="<?php echo set_value('text'); ?>" class="<?php echo (form_error('text')) ? 'inp-form-error' : 'inp-form'; ?>" /></td>
				<td><?php echo form_error('text'); ?></td>
			</tr>
			<tr>
				<th valign="top">URL:</th>
				<td><input name="url" type="text" value="<?php echo set_value('url'); ?>" class="<?php echo (form_error('url')) ? 'inp-form-error' : 'inp-form'; ?>" /></td>
