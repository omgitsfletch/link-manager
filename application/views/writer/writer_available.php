        ...
        <div class="table_wrap">
          ...
          <table class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td width="34%"><a href="<?php echo base_url();?>writer/available/<?php echo $values['article_id'];?>"><?php echo $values['topic'];?></a></td>
              ...
              <td width="20%">
                 ...
                 <span><a href="<?php echo base_url();?>writer/available/<?php echo $values['article_id'];?>"><i class="icon-edit"></i></a></span>
              </td> 
            </tr>
            <?php }?>
          </table>
