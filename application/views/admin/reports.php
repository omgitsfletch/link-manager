...
function pageselectCallback(page_index, jq){
    ...
    $.ajax({
		url: site_url+'admin/report_ajax',
		type:'POST',
		data:{
				submit: is_filter,
	   ...
	   endDate = '<?php echo date('Y-m-d');?>';
		...
		$('#end_date').datepicker()
		 ...
		 $('.detail_report').live('click',function(){
		     ...
		     var end_date = $('#end_date').val();
		     if((curent_date != end_date || curent_date != start_date)){
		    	window.location = '<?php echo base_url();?>admin/detail_report/'+$(this).attr('rel')+'/'+encodeURIComponent(start_date)+'/'+encodeURIComponent(end_date);
		     }else{
		    	window.location = '<?php echo base_url();?>admin/detail_report/'+$(this).attr('rel');
			 }
		 });
   });
</script>
      ...
      <div class="span12">
        <div class="table_wrap">
          ...
          <div class="head_wrap">
            ...
            <!-- <div class="links"> <a href="<?php echo base_url();?>admin/submitted"># <?php echo _("of Submissions");?></a>
              <div class="clear">&nbsp;</div>
            </div> -->
            <div class="clear">&nbsp;</div>
          </div>
          <table id="report" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td width="15%">
              	<a href="<?php echo base_url();?>admin/detail_report/<?php echo $report['id'];?>"><button type="button" class="btn" name="detail" value="detail" title="Detail Report"><?php echo _("Detail");?></button></a>
              </td>
            </tr>
