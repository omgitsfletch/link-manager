      ...
      <div class="span12">
        <div class="table_wrap">
          <div class="head_wrap">
            ...
            <div class="links"> <a href="<?php echo base_url();?>admin/approved"><?php echo _("Back to Approved");?></a>
              <div class="clear">&nbsp;</div>
            </div>
            <div class="clear">&nbsp;</div>
          </div>
          <table class="table table-bordered table-striped">
            <tr>
              <td>
                ...
                <form class="form-horizontal" action="<?php echo base_url();?>admin/publish_article" method="POST">
