<html>
	...
	<body>
		...
		<div id="wrapper">
			<div class="add_link">
				<a href="<?php echo base_url().'admin/dashboard';?>"><?php echo _("Back to Dashboard");?></a><br />
	        ...
	        <div class="main_content">
	        	<div id="submitted_articles">
					...
					<?php if($current_page_is == 'submitted'){?>				
					<div class="article_info">
						<form action="<?php echo base_url().'admin/approve_article'?>" method="POST">
					...
					<div class="article_info">
						<form action="<?php echo base_url().'admin/decline_article'?>" method="POST">
							<input type='hidden' value='<?php echo $article_info['0']['article_id'];?>' id='article_id' name='article_id' />
        					<input type='hidden' value='<?php echo $article_info['0']['writer_id'];?>' id='writer_id' name='writer_id' />
					...
					<div class="article_info">
					<form action="<?php echo base_url().'admin/publish_article'?>" method="POST">
						<input type='hidden' value='<?php echo $article_info['0']['article_id'];?>' id='article_id' name='article_id' />
        					<input type='hidden' value='<?php echo $article_info['0']['writer_id'];?>' id='writer_id' name='writer_id' />
