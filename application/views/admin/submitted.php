          ...
          <table class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td width="30%">
              	...
              	<!-- <a href="<?php echo base_url();?>admin/submit/article/<?php echo $values['writer_id'];?>/<?php echo $values['article_id'];?>"><?php echo $values['topic'];?></a> -->
              </td>
              <td width="20%">
              ...
              <td width="20%">
                 ...
                 <a href="<?php echo base_url();?>admin/submit/article/<?php echo $values['writer_id'];?>/<?php echo $values['article_id'];?>"><span class="btn" title="<?php echo _("Edit");?>"><i class="icon-edit"></i></span></a>
              </td> 
            </tr>
            <?php }?>
          </table>
