            ...
            <tr>
              <td>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input class="input-xxlarge" type="text" value="<?php if(!empty($copyscape_settings)){ echo $copyscape_settings['0']['copyscape_username'];}?>" id="copyscape_username" name="copyscape_username" />
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input class="input-xxlarge" type="text" value="<?php if(!empty($copyscape_settings)){ echo $copyscape_settings['0']['copyscape_api_key'];}?>" id="copyscape_api_key" name="copyscape_api_key" />
                    </div>
                  </div>
                  
                  <div class="control-group">
                    <div class="controls">
                      <button type="submit" class="btn btn-success" name="submit" value="edit_copyscape"><i class="icon-check"></i> <?php echo _("Update");?></button>
                    </div>
                  </div>
        ...
        <div class="table_wrap">
          ...
          <table class="table table-bordered table-striped">
            <tr>
              ...
              <th width="10%"><?php echo _("Articles in this group");?></th>
              <th width="20%"><?php echo _("Added at");?></th>
              <th width="25%"><?php echo _("Action");?></th>
            </tr>
            <?php foreach($available_groups as $values){?>
            <tr id="tr_<?php echo $values['group_id'];?>">
              <td width="1%"><a href="javascrpit: void(0);"><i class="icon-plus-sign"></a></i></td>
              <td width="10%"><?php echo $values['group_id'];?></td>
              <td width="34%"><?php echo $values['name'];?></td>
              <td width="10%"><?php echo $values['article_assigned'];?></td>
              <td width="20%"><?php $timestamp = strtotime($values['date_added']); echo date('D', $timestamp);?>, <?php echo date('m-d-Y',$timestamp)?></td>
              <td width="25%">
              	 <a href="#edit_group" data-toggle="modal" rel="<?php echo $values['group_id'];?>" class="edit_grp"><button type="button" class="btn btn-info" name="edit" value="edit"><?php echo _("Edit");?></button></a>
                 <a class="delete" rel="<?php echo $values['group_id'];?>" href="javascript: void(0);"><span class="btn btn-danger"><i class="icon-remove-circle"></i></span></a>
              </td> 
            </tr>
            <?php }?>
          </table>
            ...
            <div class="modal-body">
	        	<form action="" method="post" class="form-horizontal">
		            ...
		            <div class="modal-footer">
	                      ...
	                      <button type="submit" class="btn btn-success" name="submit" value="edit_grp"><i class="icon-check"></i> <?php echo _("Change");?></button>
	                </div>
		        </form
	        </div>
        </div>
            ...
            <tr>
              <td>
	        	<form action="" method="post" class="form-horizontal">
		            ...
		            <div class="modal-footer">
	                      <button type="submit" class="btn btn-success" name="submit" value="add_grp"><i class="icon-check"></i> <?php echo _("Add");?></button>
	                </div>
		        </form>
			 </td>
            </tr>
