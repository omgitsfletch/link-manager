          ...
          <table class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td width="30%">
                 ...
                 <a href="<?php echo base_url();?>editor/approved/<?php echo $values['writer_id'];?>/<?php echo $values['article_id'];?>"><span class="btn btn-info" title="<?php echo _("View");?>"><i class="icon-edit"></i></span></a>
                 <a href="#TB_inline?height=300&width=550&inlineId=content_<?php echo $values['article_id'];?>" class="thickbox"><span class="btn btn-info"><?php echo _("view");?></span></a>
                 ...
                 <a href="<?php echo base_url();?>editor/export_approved/<?php echo $values['article_id'];?>"><span class="btn btn-info" title="<?php echo _("Export this article on a word file");?>"><?php echo _("Export");?></span></a>
              </td> 
            </tr>
            <?php }?>
          </table>
            ...
            <div class="modal-body">
	        	<form action="" method="post" class="form-horizontal">
		            ...
		            <div class="modal-footer">
	                	...
	                	<button type="submit" class="btn btn-success" name="submit" value="assigned" onSubmit="return validate_assigning();"><i class="icon-check"></i> <?php echo _("Done");?></button>
	                </div>
		        </form
	        </div>
        </div>
