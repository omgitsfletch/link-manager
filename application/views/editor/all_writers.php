...
<script type="text/javascript">
   $(document).ready(function(){
       ...
       $('.update').click(function(){
           ...
           window.location = '<?php echo base_url();?>editor/update_writer/'+input_id+'/'+value+'/'+max_claimable+'/'+status;
       });

       $('.delete').click(function(){
           var conf = confirm("Are you sure you want to delete this writer?");
	   	    if(conf == true){
	   	    	window.location = '<?php echo base_url();?>editor/delete_writers/'+$(this).attr('rel');
	   	    }
      });

       $('.tooltips').click(function(){
           var writer_id = $(this).attr('rel');
           $('#editor_note').val($('#am_'+writer_id).val());
          ...
          <table class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td width="15%">
                ...
                <a href="javascript: void(0);" rel="<?php echo $values['id'];?>" class="update" ><span class="btn btn-success" title="<?php echo _("Update User");?>"><?php echo _("Update");?></span></a>              	
                <a href="javascript: void(0);" rel="<?php echo $values['id'];?>" class="delete"><span class="btn btn-danger" title="<?php echo _("Delete User");?>"><i class="icon-remove-circle"></i></span></a>
              </td>
            </tr>
            <?php }?>
          </table>
          <?php }else{?>
          <div class="no_info"><?php echo _("No Writers");?></div>
          <?php }?>
        </div>
      </div>
      ...
      <!-- ###################### Admin note Tooltip ########################### -->
        <div id="note" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        	<div class="modal-header">
                ...
                <h3 id="myModalLabel"><?php echo _("Editor Note")?></h3>
            </div>
            <div class="modal-body">
	        	<form action="" method="post" class="form-horizontal">
		            ...
		            <div class="modal-footer">
	                	...
	                	<button type="submit" class="btn btn-success" name="submit" value="update" onSubmit=""><i class="icon-check"></i> <?php echo _("Update");?></button>
	                </div>
		        </form
	        </div>
        </div>
