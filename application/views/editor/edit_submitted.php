      ...
      <div class="span12">
        <div class="table_wrap">
          <div class="head_wrap">
            ...
            <div class="links"> <a href="<?php echo base_url();?>editor/submitted"><?php echo _("Back to submitted");?></a>
              <div class="clear">&nbsp;</div>
            </div>
            <div class="clear">&nbsp;</div>
          </div>
                ...
                <form class="form-horizontal" action="" method="POST">
                  ...
                  <div class="control-group">
                    <div class="controls">                     
                      ...
                      <button type="submit" class="btn" id="publish" name="publish" value="publish"><i class="icon-time"></i> <?php echo _("Publish");?></button>
                      <button type="submit" class="btn" id="edit" name="edit" value="edit"><i class="icon-edit"></i> <?php echo _("Edit");?></button>
                      <a href="#TB_inline?height=300&width=550&inlineId=reject_popup&modal=true" class="thickbox"><button type="submit" class="btn" id="reject" name="reject" value="reject"><i class="icon-ban-circle"></i> <?php echo _("Reject")?></button></a>
        ...
        <div id="content_<?php echo $article_info['0']['article_id'];?>" style="display: none;">
         	<div style="text-align: center"><u><?php echo $article_info['0']['title'];?></u></div>
