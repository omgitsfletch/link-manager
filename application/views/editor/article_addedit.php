      ...
      <div class="span12">
        <div class="table_wrap">
          <div class="head_wrap">
            ...
            <div class="links">
            	<a href="<?php echo base_url();?>editor/articles"><?php echo _('Back to Articles');?></a>
                <div class="clear">&nbsp;</div>
            </div>
            <div class="clear">&nbsp;</div>
          </div>
              ...
              <td>
                  ...
                  <div class="control-group">
                    <div class="controls">
                      ...
                      <button type="submit" class="btn btn-success" name="submit"><i class="icon-check"></i> <?php echo _("Edit");?></button>
                      <?php }else{?>
