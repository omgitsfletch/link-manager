...
<link href="<?php echo base_url();?>assets/css/tipsy.css" rel="stylesheet" />
...
<script type="text/javascript">
   $(document).ready(function(){
       ...
       $('.delete').click(function(){
    	    ...
    	    if(conf == true){
    	    	window.location = '<?php echo base_url();?>editor/delete_available/'+$(this).attr('rel');
    	    }
       });
       $('.btn').tooltip();
      ...
      <div class="span12">
        ...
        <!-- ##################### ASSIGNED ARTICLES ################################### -->
          ...
          <table class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td width="34%">
              	<a title="<?php echo $values['topic'];?>" rel="popover" class="pop" href="javacript: void(0);">
              		<?php 
              ...
              <td width="20%">
                <span class="btn btn-success"><?php echo $values['due_date'];?></span>
        ...
        <!-- ##################### CLAIMED ARTICLES ################################### -->
          ...
          <table class="table table-bordered table-striped">
            <tr>
              ...
              <th width="10%"><?php echo _("Due Date");?></th>
              <th width="20%"><?php echo _("Due Day");?> / <?php echo _("Length");?></th>
            </tr>
            ...
            <tr>
              ...
              <td width="20%">
                <a href="javascript: void(0);" original-title="<?php echo $time;?>" class="time_left"><span class="btn btn-danger" title=""><?php echo $values['due_time'];?></span></a>
                <span class="btn"><?php echo $values['length'];?></span>
              </td>
            </tr>
            <?php }?>
          ...
          <div class="head_wrap">
            ...
            <div class="links">
            	<!-- <a href="<?php echo base_url();?>editor/add"><?php echo _("Add Article");?></a> -->
          ...
          <table class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td width="25%">
                 <span class="btn btn-success"><?php echo $values['due_date'];?></span>
                 <span class="btn"><?php echo $values['length'];?></span>
                 <a href="<?php echo base_url();?>editor/available/<?php echo $values['article_id'];?>"><span class="btn btn-info" title="Edit"><i class="icon-edit"></i></span></a>
                 <a class="delete" rel="<?php echo $values['article_id'];?>" href="javascript: void(0);"><span class="btn btn-danger" title="Delete"><i class="icon-remove-circle"></i></span></a>
                 <a href="#assign_article" data-toggle="modal" class="assigning_class" rel="<?php echo $values['article_id'];?>"><button type="button" class="btn btn-info" name="assign" value="assign"><?php echo _("Assign");?></button></a>
              </td> 
            </tr>
            <?php }?>
          </table>
        ...
        <div id="add_article" class="table_wrap" style="display: none;">
          ...
          <table class="table table-bordered table-striped">
            <tr>
              <td>
              	<form action="<?php echo base_url().'editor/add';?>" method="post" class="form-horizontal">
                  <div class="control-group" style="float: left;">
                    <label class="control-label" for="article_topic"><?php echo _("Article topic");?>: </label>
                    <div class="controls">
                      <input class="input-small" type="text" value="" id="article_topic" name="article_topic" />
                    </div>
                  </div>
                                      	
                  <div class="control-group" style="float: left;">
                    <label class="control-label" for="length" style="width: 100px;"><?php echo _("Length");?>: </label>
                    <div class="controls" style="margin-left: 115px;">
                      <input class="input-small" type="text" value="" id="length" name="length" />
                    </div>
                  </div>
                  
                  <div class="control-group" style="float: left;">
                     <label class="control-label" for="due_date" style="width: 100px;"><?php echo _("Due Date")?>:</label>
                    <div class="controls" style="margin-left: 115px;">
                      <select id="due_date" name="due_date" style="width: 100px;">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <textarea id="keywords" name="keywords" rows="2" class="input-xxlarge"></textarea>
                    </div>
                  </div>
                  ...
                  <div class="control-group" style="float: left;">
                    ...
                    <div class="controls">
                      <textarea id="anchor_text" name="anchor_text" rows="2" class="input-large"></textarea>
                    </div>
                  </div>
                  
                  <div class="control-group" style="float: left;">
                    <label class="control-label" for="urls" style="width: 87px;"><?php echo _("Urls");?>:<br />(<?php echo _("Comma separated");?>)</label>
                    <div class="controls" style="margin-left: 96px;">
                      <textarea id="urls" name="urls" rows="2" class="input-large" ></textarea>
                    </div>
                  </div>
                  <div class="clear"></div>
                  
                  <div class="control-group" style="float: left;">
                    <label class="control-label" for="admin_note"><?php echo _("Editor Note");?>:</label>
                    <div class="controls">
                  ...
                  <div class="control-group">
                    <div class="controls">
                      ...
                      <button type="submit" class="btn btn-success" name="submit"><i class="icon-check"></i> <?php echo _("Add This Article");?></button>
                    </div>
                  </div>
        ...
        <div id="assign_article" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
	        	<form action="<?php echo base_url().'editor/assign_to'?>" method="post" class="form-horizontal">
	            	<div class="control-group">
		            ...
		            <div class="modal-footer">
	                	...
	                	<button type="submit" class="btn btn-success" name="submit" value="assigned" onSubmit="return validate_assigning();"><i class="icon-check"></i> <?php echo _("Assign");?></button>
	                </div>
		        </form
	        </div>
        </div>
