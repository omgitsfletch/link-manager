          ...
          <table class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td width="20%">
                 ...
                 <a href="<?php echo base_url();?>editor/submit/article/<?php echo $values['writer_id'];?>/<?php echo $values['article_id'];?>"><span class="btn btn-info" title="<?php echo _("Edit");?>"><i class="icon-edit"></i></span></a>
              </td> 
            </tr>
            <?php }?>
          </table>
