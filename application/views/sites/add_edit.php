	...
	<tr>
		...
		<td>
			...
			<tr>
				...
				<td><input name="name" type="text" value="<?php echo set_value('name', (isset($name) ? $name : '')); ?>" class="<?php echo (form_error('name')) ? 'inp-form-error' : 'inp-form'; ?>" /></td>
				<td><?php echo form_error('name'); ?></td>
			</tr>
			<tr>
				<th valign="top">URL:</th>
				<td><input name="url" type="text" value="<?php echo set_value('url', (isset($url) ? $url : '')); ?>" class="<?php echo (form_error('url')) ? 'inp-form-error' : 'inp-form'; ?>" /></td>
