                        ...
                        case 'horizontalLine':
                            ...
                            if (obj.options.y != null) {
                                ...
                                if (obj.options.xmin != null) {
                                    ...
                                    if (typeof(xminoff) == "number") {
                                        xstart = xaxis.series_u2p(xaxis.min + xminoff);
                                    }
                                    else if (typeof(xminoff) == "string") {
                                ...
                                if (obj.options.xmax != null) {
                                    ...
                                    if (typeof(xmaxoff) == "number") {
                                        xstop = xaxis.series_u2p(xaxis.max - xmaxoff);
                                    }
                                    else if (typeof(xmaxoff) == "string") {
                        ...
                        case 'verticalLine':
                            ...
                            if (obj.options.x != null) {
                                ...
                                if (obj.options.ymin != null) {
                                    ...
                                    if (typeof(yminoff) == "number") {
                                        ystart = yaxis.series_u2p(yaxis.min - yminoff);
                                    }
                                    else if (typeof(yminoff) == "string") {
                                ...
                                if (obj.options.ymax != null) {
                                    ...
                                    if (typeof(ymaxoff) == "number") {
                                        ystop = yaxis.series_u2p(yaxis.max + ymaxoff);
                                    }
                                    else if (typeof(ymaxoff) == "string") {
